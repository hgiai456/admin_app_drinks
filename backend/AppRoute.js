...
export function AppRoute(app) {
  ...
  router.delete("/products/:id", asyncHandle(ProductController.deleteProducts));
  //User
  ...
  router.put("/cart-items/:id", asyncHandle(CartItemController.updateCartItem)); // Cập nhật số lượng item
  router.delete(
    "/cart-items/:id",
