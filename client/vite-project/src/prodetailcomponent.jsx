...
function ProdetailComponent() {
  ...
  const validateForm = () => {
    ...
    if (!form.prouduct_id) newErrors.prouduct_id = "ID sản phẩm là bắt buộc";
              ...
              <div style={{ flex: 1 }}>
                <input
                  ...
                  style={{
                    width: "100%",
                    padding: 8,
                    border: errors.size_id ? "1px solid red" : "1px solid #ccc",
                    borderRadius: 4,
                  }}
                />
                {errors.size_id && (
            ...
            <div style={{ marginBottom: 15 }}>
              <input
                ...
                style={{
                  width: "100%",
                  padding: 8,
                  border: errors.store_id ? "1px solid red" : "1px solid #ccc",
                  borderRadius: 4,
                }}
              />
              {errors.store_id && (
